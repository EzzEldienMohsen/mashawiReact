...
const SidePageHero:React.FC<SidePageHeroProps>= ({ img, primaryText, secondaryText, isJob }) => {
  return (
    ...
    >
      <div className="flex flex-col md:text-start justify-center items-center md:justify-start md:items-start lg:w-2/5">
        <h1 className="mb-4 text-lg md:text-2xl lg:text-4xl my-1 md:text-start font-bold text-[#CD0B09]">
          {primaryText}
        </h1>
        <p className="text-white text-sm md:text-md text-center md:text-start lg:text-lg my-1">
          {secondaryText}
        </p>
      </div>
      <img
