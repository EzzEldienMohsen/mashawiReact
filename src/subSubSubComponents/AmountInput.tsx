...
const AmountInput: React.FC<AmountProps> = ({ amount, setAmount }) => {
  ...
  return (
    <div className="w-3/5 md:w-4/5 lg:w-2/5 2xl:w-2/5 flex justify-between items-center p-[3px] 2xl:p-2 rounded-3xl 2xl:rounded-full bg-[#F5F5F5] gap-x-1 2xl:gap-x-4">
      <button
